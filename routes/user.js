...
router
  .route("/user/").get(auth(), userController.getCurrentUser)
  .post(auth(), validate(userValidation.updateProfileDetails),
    upload.single("avatar"), userController.addOrUpdateProfile
  );
